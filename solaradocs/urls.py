...
urlpatterns = [
    ...
    path('billing-portal/', views.billing_portal_session, name='billing_portal_session'),
    path('profile/redirect-toggle/', views.toggle_redirect_to_dashboard, name='toggle_redirect_to_dashboard'),
    path('api/recent-projects/', views.recent_projects, name='recent_projects'),
    ...
    path('api/project/<int:project_id>/google/picker-config', views_import.picker_config, name='picker_config'),
